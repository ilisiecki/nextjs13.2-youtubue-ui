      ...
      {isAboveSizeScreen && isMenuOpen ? (
        ...
        <>
          {isMenuOpen ? (
            ...
            <>
              <aside className="invisible -mt-9 ml-1 flex flex-col screenSM:visible">
                <div className="flex items-center justify-center rounded-lg hover:bg-zinc-700">
                  <button
                ...
                <div className="flex items-center justify-center rounded-lg hover:bg-zinc-700">
                  ...
                  >
                    ...
                    <span className="mt-1 text-xxs">Shorts</span>
                  </button>
                </div>
                <div className="flex items-center justify-center rounded-lg hover:bg-zinc-700">
                  <button
                  ...
                  >
                    ...
                    <span className="mt-1 text-xxs">Subscriptions</span>
                  </button>
                </div>
                <div className="flex items-center justify-center rounded-lg hover:bg-zinc-700">
                  <button
                  ...
                  >
                    ...
                    <span className="mt-1 text-xxs">Library</span>
                  </button>
                </div>
                <div className="flex rounded-lg hover:bg-zinc-700">
                  <button
                    className="flex flex-col items-center justify-center px-5 py-4"
                    onClick={() => handleItemClick(4)}
                  >
                    ...
                    <span className="mt-1 text-xxs">History</span>
                  </button>
                </div>
              </aside>
            </>
