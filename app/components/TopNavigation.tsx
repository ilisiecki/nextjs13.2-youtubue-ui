      ...
      <div className="flex items-center justify-between px-4 pt-2">
        ...
        <div className="hidden h-10 w-[41rem] screenT:flex">
          ...
          <button className="has-tooltip">
            <span className="tooltip mt-16 -ml-6 flex items-center justify-center rounded-md bg-zinc-500 bg-opacity-90 py-1.5 px-3 text-xs">
        ...
        <div className="flex shrink-0 items-center justify-center">
          ...
          <div className="z-50 mx-4 mt-2">
            <DropdownDots />
          </div>
          <button className="flex h-9 w-24 cursor-pointer items-center justify-center rounded-full border-[1px] border-zinc-600 text-sm font-medium text-blue-yt hover:border-none hover:bg-blue-yt hover:bg-opacity-25">
            <svg viewBox="0 0 24 24" width={24} className="mx-1 fill-blue-yt">
