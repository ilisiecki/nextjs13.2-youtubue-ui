  ...
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog
          as="div"
          className="relative z-30 border-2 border-blue-500"
          onClose={closeModal}
        >
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 h-full w-60 overflow-y-auto">
            <div className="flex h-full w-full">
              <Transition.Child
                as={Fragment}
                enter="-translate-x-60 duration-100"
                enterTo="translate-x-0"
                leave="translate-x-0 duration-100"
                leaveTo="-translate-x-60"
              >
                <Dialog.Panel className="flex w-full flex-col bg-zinc-900 text-left shadow-xl transition-all">
                  <div className="flex flex-row">
                    <button
                      className="mx-4 my-2 flex h-10 w-10 items-center justify-center rounded-full hover:bg-zinc-600"
                      onClick={setMenuClose}
                    >
                      <svg
                        viewBox="0 0 24 24"
                        width={24}
                        className="style-scope yt-icon fill-white"
                      >
                        <path d="M21,6H3V5h18V6z M21,11H3v1h18V11z M21,17H3v1h18V17z"></path>
                      </svg>
                    </button>
                    <div className="my-2 flex h-10 cursor-pointer items-center">
                      <svg
                        viewBox="0 0 90 20"
                  ...
                  <div className="mt-4 flex h-full bg-zinc-900	">
